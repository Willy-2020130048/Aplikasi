...
<main class="w-full flex flex-col items-center pt-16">
    <div
        ...
        <div>
            <img src="https://azerty.my.id/storage/Logo.png" class="object-cover h-36 w-36">
        </div>
            ...
            <div class="w-full mt-5">
                ...
                <div
                    class="py-3 flex items-center text-xs text-gray-400 uppercase before:flex-1 before:border-t before:border-gray-200 before:me-6 after:flex-1 after:border-t after:border-gray-200 after:ms-6 dark:text-gray-500 dark:before:border-gray-600 dark:after:border-gray-600">
                    Or</div> --}}
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="grid gap-y-4">
                        <!-- Form Group -->
                        <div>
                            <label for="email" class="block text-sm mb-2 dark:text-white">Username / Email</label>
                            <div class="relative">
                                <input type="text" id="email" name="email"
                                    class="border-2 py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                        ...
                        <div>
                            <div class="flex justify-between items-center">
                                ...
                                <a class="text-sm text-blue-600 decoration-2 hover:underline font-medium"
                                    href="/recovery">Forgot password?</a>
                            </div>
                            <div class="relative">

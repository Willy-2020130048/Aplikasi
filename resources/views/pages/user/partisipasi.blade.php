...
@section('main')
    <main class = "w-full flex flex-col items-center">
            ...
            <div class="mt-8 w-full max-w-4xl relative bg-white border rounded-xl md:p-10 dark:bg-gray-950 dark:border-neutral-800">
        ...
        @foreach ($acaras as $acara)
            <div
                ...
                <h3 class="mb-8 text-2xl font-bold text-gray-800 dark:text-neutral-200 text-center">{{ $acara->statusacara }}</h3>

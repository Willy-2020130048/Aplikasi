    ...
    <div
        ...
        dark:bg-gray-800 dark:text-white dark:border-gray-800"
                ...
                <div class="py-1">
                    ...
                    <input placeholder="" type="text" name="jenis_kelamin" value="{{ auth()->user()->jenis_kelamin }}"
                        class="text-md block px-3 py-2 rounded-lg w-full
        bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none
        dark:bg-gray-800 dark:text-white dark:border-gray-800"
                        disabled>
        ...
        dark:bg-gray-800 dark:text-white dark:border-gray-800"
                ...
                <div class="py-1">
                    ...
                    <input placeholder="" type="date" name="tanggal_lahir" value="{{ auth()->user()->tanggal_lahir }}"
                        class="text-md block px-3 py-2 rounded-lg w-full
        bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none
        dark:bg-gray-800 dark:text-white dark:border-gray-800"
                        disabled>
        ...
        dark:bg-gray-800 dark:text-white dark:border-gray-800"
                ...
                <div class="py-1">
                    ...
                    <input placeholder="" type="text" name="provinsi" value="{{ $dataProv[0]->name }}"
                        class="text-md block px-3 py-2 rounded-lg w-full
        bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none
        dark:bg-gray-800 dark:text-white dark:border-gray-800"
                        disabled>
                ...
                <div class="py-1">
                    ...
                    <input placeholder="" type="text" name="instansi" value="{{ $dataInstansi[0]->nama_unit }}"
                        class="text-md block px-3 py-2 rounded-lg w-full
        bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none
        dark:bg-gray-800 dark:text-white dark:border-gray-800"
                        disabled>

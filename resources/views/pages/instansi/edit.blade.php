    ...
    <div
        ...
        <div class="p-4 sm:p-7">
            <div class="text-center">
                <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Edit Instansi</h1>
            </div>
            <div class="mt-5">
                <!-- Form -->
                <form id="goRegister" method="POST" action="{{ route(auth()->user()->role . '_instansi.store') }}"
                    ...
                    <div class="mx-auto max-w-lg ">
                        <div class="py-1">
                            ...
                            <input placeholder="" type="text" name="kode_unit" value="{{ $instansi->kode_unit }}"
        ...
        bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none">
                        ...
                        <div class="py-1">
                            ...
                            <input placeholder="" type="text" name="nama_unit" value="{{ $instansi->nama_unit }}"
                                class="text-md block px-3 py-2 rounded-lg w-full
        bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none">
                        </div>
                        @error('nama_unit')
                        ...
                        bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none"
                                ...
                                @foreach ($dataProv as $prov)
                                    <option value="{{ $prov->id }}" @if ($prov->id == $instansi->id_pw) selected @endif>
                                        {{ $prov->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none"
                                ...
                                @foreach ($dataProv as $prov)
                                    <option value="{{ $prov->id }}" @if ($prov->id == $instansi->id_propinsi) selected @endif>
                                        {{ $prov->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="py-1">
                            ...
                            <input placeholder="" type="alamat" name="alamat" value="{{ $instansi->alamat }}"
                                class="text-md block px-3 py-2 rounded-lg w-full
        bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none">
                        </div>
                        @error('alamat')
                        ...
                        <div class="py-1">
                            ...
                            <input placeholder="" type="no_telp" name="no_telp" value="{{ $instansi->no_telp }}"
                                class="text-md block px-3 py-2 rounded-lg w-full
        bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none">
                        </div>
                        @error('no_telp')
                        ...
                        <div class="py-1">
                            ...
                            <input placeholder="" type="email" name="email" value="{{ $instansi->email }}"
                                class="text-md block px-3 py-2 rounded-lg w-full
        bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none">
                        </div>
                        @error('email')
